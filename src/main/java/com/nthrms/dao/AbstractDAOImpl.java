...
import com.nthrms.dao.AbstractDAO;
...
public abstract class AbstractDAOImpl<E, I extends Serializable> implements
	...
	E objectReturn = (E) getCurrentSession().get(entityClass, tmpID);
	return objectReturn;
    }
	...
	@SuppressWarnings("unchecked")
	List<E> listReturn = criteria.list();
	return listReturn;
    }

    public List<E> getByCriteria(List<Criterion> criterionList) {
	Session ss = getCurrentSession();
	Criteria criteria = ss.createCriteria(entityClass);
