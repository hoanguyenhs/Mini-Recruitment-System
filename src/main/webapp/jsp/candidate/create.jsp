    			...
    			<div class="form-group">
      			...
      			<div class="form-group">
    				...
    				<div class="col-lg-10">
	    				...
	    				<%@include file="/jsp/candidate/create-certificate.jsp"%>
    				</div>
    			</div>
    			<div class="form-group">
    				...
    				<div class="col-lg-10">
	    				...
	    				<%@include file="/jsp/candidate/create-experience.jsp"%>
    				</div>
    			</div>
    			<div class="form-group">
    				<label class="col-lg-2 control-label nth-label">Skill</label>
    				<div class="col-lg-10">
	    				<%@include file="/jsp/candidate/create-skill.jsp"%>
    				</div>
    			</div>
  			</fieldset>
		</form:form>
...
<div class="modal fade" id="nth-cancel-modal" tabindex="-1">
  	<div class="modal-dialog">
      	...
      	<div class="modal-body">
        	<p>Are you sure want to cancel the create candidate operation?</p>
      	</div>
