...
<script>
	var index1 = ${experienceModelListLength };
	divCertificate = ''
...
<div class="nth-certificate-container">
	<c:forEach var="certificateModel" items="${certificateModelList }">
		<div class="nth-certificate">
			<div class="form-group">
				<label class="col-lg-2 control-label nth-label">Name</label>
				<input name="certificateName" class="col-lg-4 form-control nth-input" placeholder="Name" type="text" value="${certificateModel.name }"></input>
				<label class="col-lg-2 control-label nth-label">Start Date</label>
				<input name="certificateStarDate" class="col-lg-4 form-control nth-input datetimepicker startdate" placeholder="Star Date" type="text" value="${certificateModel.startDate }"></input>
			</div>
			<div class="form-group">
				<label class="col-lg-2 control-label nth-label">School</label>
				<input name="certificateSchool" class="col-lg-4 form-control nth-input" placeholder="School" type="text" value="${certificateModel.school }"></input>
				<label class="col-lg-2 control-label nth-label">End Date</label>
				<input name="certificateEndDate" class="col-lg-4 form-control nth-input datetimepicker enddate" placeholder="End Date" type="text" value="${certificateModel.endDate }"></input>
			</div>
			<div class="form-group" style="margin-bottom: 0px;">
				<label class="col-lg-2 control-label nth-label">Score</label>
				<input name="certificateScore" class="col-lg-4 form-control nth-input" placeholder="Score" type="text" value="${certificateModel.score }"></input>
				<div class="col-lg-5">
					<span style="margin-right: 50px;"></span>
					<button type="button" class="btn btn-success nth-button-add">+</button>
					<button type="button" class="btn btn-danger nth-button-remove">-</button>
