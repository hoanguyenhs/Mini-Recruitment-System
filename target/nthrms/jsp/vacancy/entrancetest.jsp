	...
	<div class="panel panel-success">	
		...
		<div class="panel-body">
			<div class="nth-button-group">
				<a class="btn btn-info nth-button" href="${pageContext.request.contextPath}/vacancy/view/${vacancyModel.id }/entrancetest/${candidateModel.id }/pass">
					<span class="glyphicon glyphicon-ok-sign"></span>
					Pass
				</a>
				<a class="btn btn-info nth-button" href="${pageContext.request.contextPath}/vacancy/view/${vacancyModel.id }/entrancetest/${candidateModel.id }/reject">
