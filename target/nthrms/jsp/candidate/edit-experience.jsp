...
<script>
	var index2 = ${experienceModelListLength };
	divExperience = ''
...
<div class="nth-experience-container">
	<c:forEach var="experienceModel" items="${experienceModelList }">
		...
		<div class="form-group">
			<label class="col-lg-2 control-label nth-label">Company</label>
			<input name="experienceCompany" class="col-lg-4 form-control nth-input" placeholder="Company" type="text" value="${experienceModel.company }"></input>
			<label class="col-lg-2 control-label nth-label">Start Date</label>
			<input name="experienceStarDate" class="col-lg-4 form-control nth-input datetimepicker startdate" placeholder="Star Date" type="text" value="${experienceModel.startDate }"></input>
		</div>
		<div class="form-group">
			<label class="col-lg-2 control-label nth-label">Position</label>
			<input name="experiencePosition" class="col-lg-4 form-control nth-input" placeholder="Position" type="text" value="${experienceModel.position }"></input>
			<label class="col-lg-2 control-label nth-label">End Date</label>
			<input name="experienceEndDate" class="col-lg-4 form-control nth-input datetimepicker enddate" placeholder="End Date" type="text" value="${experienceModel.endDate }"></input>
		</div>
		<div class="form-group" style="margin-bottom: 0px;">
			<label class="col-lg-2 control-label nth-label">Salary</label>
			<input name="experienceSalary" class="col-lg-4 form-control nth-input" placeholder="Salary" type="text" value="${experienceModel.salary }"></input>
			<div class="col-lg-5">
				<span style="margin-right: 50px;"></span>
				<button type="button" class="btn btn-success nth-button-add1">+</button>
				<button type="button" class="btn btn-danger nth-button-remove1">-</button>
